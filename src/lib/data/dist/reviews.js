...
var getReviews = function () { return __awaiter(void 0, void 0, void 0, function () {
    var headers, _a, res;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, config_1.fetchQuery("/store/reviews", {
                        headers: headers,
                        method: "GET",
...
var createReview = function (review) { return __awaiter(void 0, void 0, void 0, function () {
    var headers, _a, response;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = [{}];
            ...
            case 1:
                ...
                return [4 /*yield*/, fetch(process.env.MEDUSA_BACKEND_URL + "/store/reviews", {
                        headers: headers,
                        method: "POST",
                        body: JSON.stringify(review)
                    }).then(function (res) {
                        cache_1.revalidatePath("/user/reviews");
                        cache_1.revalidatePath("/user/reviews/written");
                        return res;
                    })];
            case 2:
                response = _b.sent();
