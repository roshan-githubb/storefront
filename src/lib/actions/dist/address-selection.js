...
exports.applySelectedAddressToCart = void 0;
var cart_1 = require("@/lib/data/cart"); // Import your Server Action
/**
 ...
 */
function applySelectedAddressToCart(address) {
    return __awaiter(this, void 0, void 0, function () {
        var formData, nameParts, first_name, last_name, result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    formData = new FormData();
                    nameParts = address.name.trim().split(/\s+/);
                    ...
                    return [4 /*yield*/, cart_1.setAddresses(null, formData)];
                case 1:
                    result = _a.sent();
                    if (result) {
...
exports.applySelectedAddressToCart = applySelectedAddressToCart;
