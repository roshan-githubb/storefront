...
//   const productName = api_product.title || "Product"
//   const productImage =
//     api_product?.images?.[0]?.url
//       ? decodeURIComponent(api_product.images[0].url)
...
//       <div className="relative w-full h-full bg-primary aspect-square">
//         <LocalizedClientLink
//           href={`/products/${api_product.handle}`}
//           aria-label={`View ${productName}`}
//           title={`View ${productName}`}
//         >
//           <div className="overflow-hidden rounded-sm w-full h-full flex justify-center align-center">
...
//           <div className="w-full">
//             {/* TITLE */}
//             <h3 className="heading-sm truncate">{api_product.title}</h3>
