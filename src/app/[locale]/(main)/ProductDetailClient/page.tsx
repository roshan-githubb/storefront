...
export default function ProductDetailClient({ product }: { product: Product }) {
  ...
  const discountPercent =
    originalPrice > price
      ...
      : 0;
  const currency = selectedVariant?.calculated_price?.currency_code?.toUpperCase() ?? "NPR";
  ...
  return (
            ...
            <div className="flex-1">
              ...
              <div className="flex flex-wrap gap-2 mt-2">
                  ...
                  <span
                    ...
                    className="text-sm bg-[#F80000] text-white px-2 py-1 rounded-sm font-semibold"
                  >
                    #Best Seller
                  </span>
              ...
              <div className="mt-2 text-[#222222] text-sm">
                <span className="font-semibold">{product.soldLastMonth || "0"}</span> Sold Out in past month
              </div>
            </div>
          </div>
        </div>
    ...
    <div className="w-[220px] sm:w-[250px] md:w-[284px] lg:w-[296px]
      ...
      {images[index] && (
        ...
        <div className="mt-4 grid grid-cols-1 gap-4 md:grid-cols-2">
              ...
              {colors.map((c) => (
                <button
                  ...
                  className={`w-[84px] h-[74px] rounded-[8px] overflow-hidden flex items-center justify-center ${
                    selectedColor === c.id ? "border-2 border-[#1A315A]" : "border border-gray-300"
                  }`}
                >
          ...
          {/* Size */}
          <div>
            <div className="text-base font-normal mb-2 text-[#222222]">Size:</div>
        ...
        <div className="mt-3 flex flex-col gap-1">
          <div className="bg-[#F80000] text-white px-3 py-1.5 rounded-sm text-sm font-semibold w-fit">
            {discountPercent}% OFF {discountPercent > 0 ? "+ Cash on Delivery" : "+ Cash on Delivery"}
          </div>
            ...
            <table className="w-full font-semibold text-[16px] text-[#222222] text-left">
              <tbody>
                <tr>
                  ...
                  <td className="py-2 font-normal text-[16px]">{product?.material || "Not given"}</td>
                </tr>
                <tr>
...
Overall, it exceeded my expectations, and I wouldn’t hesitate to recommend it to others.`}
  ...
  <div className="max-w-4xl mx-auto flex gap-3">
    ...
    <button
      ...
      className="
        w-[180px] h-[40px]
        md:flex-1 md:w-auto md:h-[48px]
        bg-gradient-to-t from-[#3002FC] to-[#3002FC]
        text-white rounded-[24px] font-medium
    ...
    <button
      ...
      className="
        w-[180px] h-[40px]
        md:flex-1 md:w-auto md:h-[48px]
        bg-gradient-to-r from-[#FF4A53] to-[#FFA626]
        text-white rounded-[24px] font-medium
        flex items-center justify-center gap-2 shadow
      "
    >
