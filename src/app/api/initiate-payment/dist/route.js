...
function validateEnvironmentVariables() {
    ...
    for (var _i = 0, requiredEnvVars_1 = requiredEnvVars; _i < requiredEnvVars_1.length; _i++) {
        ...
        if (!process.env[envVar]) {
            console.warn("Missing environment variable: " + envVar + ", using defaults");
        }
    }
}
function POST(req) {
    return __awaiter(this, void 0, void 0, function () {
        var paymentData, amount, productName, transactionId, method, _a, transactionUuid, merchantCode, secretKey, baseUrl, esewaConfig, signatureString, signature, baseUrl, khaltiConfig, response, errorData, khaltiResponse, err_1;
                ...
                case 3:
                    {
                        ...
                        signature = generateEsewaSignature_1.generateEsewaSignature(secretKey, signatureString);
